...
- Предоставляю пример моих таблиц c dummy данными для [Sqlitebrowser](https://sqlitebrowser.org/) в файле [preduzetnik.sqlite3](secret_repository/preduzetnik.sqlite3) (открывать через Sqlitebrowser)
